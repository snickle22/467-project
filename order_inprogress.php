...
<head>
    ...
    #confirm_popup:target{
        display: block;
    }

    #shipment_popup:target{
        display: block;
    }
        ...
        <table>
            ...
            \
                ...
                foreach ($orders as $order) {
                   ...
                   /* echo "<td>";
                    if($order['email_confirmation_sent'] === 1):?>
                        <a href="#popup">Yes</a>'
                     <?php  else{
                        echo "No";
                     }
                    ...
                    echo "<td>" . ($order['email_confirmation_sent'] === 1 ? '<a href="#confirm_popup">Yes</a>' : "No") . "</td>";?>
                 <div id="confirm_popup" class="popup">
                 <a href="#">close</a>
                 <p>Hello <?php echo $order['customer_name']; ?>, </br>
                 
                 Thank you for your recent purchase. This email is to confirm your order placement <?php echo $order['order_id'] . " on " . $order['order_date'] . "."; ?> </br> </br>

                 Please expect an email confirming shipping within the next 48 hours with your tracking number. </br>
                 ...
                 USA Supplies, Inc
                  ...
                  <?php  echo "<td>" . ($order['shipment_confirmation_sent'] === 1 ? '<a href="#shipment_popup">Yes</a>' : "No") . "</td>"; ?>
                 <div id="shipment_popup" class="popup">
                 <a href="#">Close</a>
                <p>Howdy</p>
                 </div>
